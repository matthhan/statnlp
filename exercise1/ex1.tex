...
\newpage \section*{Task 4}
    \lstset{language=C++, numbers=left, breaklines=true, showspaces=false, showstringspaces=false, morecomment=[l]{//}, tabsize=2}
	\textbf{script.sh}
	\lstinputlisting{exercise01.4/script.sh}
	\textbf{word.hh}
	\lstinputlisting{exercise01.4/word.hh}
	\textbf{dictionary.hh}
	\lstinputlisting{exercise01.4/dictionary.hh}
	\textbf{dictionary.cc}
    \lstinputlisting{exercise01.4/dictionary.cc}
	\textbf{occurence\_counter.hh}
	\lstinputlisting{exercise01.4/occurence_counter.hh}
	\textbf{occurence\_counter.cc}
	\lstinputlisting{exercise01.4/occurence_counter.cc}
	\textbf{exercise01.4.cc}
	\lstinputlisting{exercise01.4/exercise01.4.cc}
\end{document}
